...
public class WorkoutHistoryAdapter extends BaseExpandableListAdapter {
    ...
    public WorkoutHistoryAdapter(Context context, List<String> dataHeader, HashMap<String, List<String>> listHashMap) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.textView = (TextView) convertView.findViewById(R.id.workout_date_textview);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.textView = (TextView) convertView.findViewById(R.id.workout_data_textview);
            convertView.setTag(holder);
        } else {
            holder = (ViewHolder) convertView.getTag();
        }
